...
class LoanPinPage extends StatefulWidget {
  const LoanPinPage({super.key});

  @override
  _LoanPinPageState createState() => _LoanPinPageState();
}

class _LoanPinPageState extends State<LoanPinPage> {
                        ...
                        Container(
                          ...
                          decoration: const BoxDecoration(
                            image: DecorationImage(
                              image: AssetImage(
                                  'assets/images/pin.png'), // Update with your image path
                        ...
                        SizedBox(
                          ...
                          child: TextField(
                            ...
                            decoration: InputDecoration(
                              counterText: '',
                              hintText: '----', // Placeholder for 4 dashes
                              filled: true,
                            ...
                            ElevatedButton(
                              onPressed: () {
                                Navigator.push(
                                  ...
                                  MaterialPageRoute(
                                    builder: (context) =>
                                        const LoanSuccessPage(), // Ensure this matches your class
                                  ),
                                );
                              },
                              style: ElevatedButton.styleFrom(
