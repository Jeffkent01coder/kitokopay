...
class LoanFailedPage extends StatefulWidget {
  const LoanFailedPage({super.key});

  @override
  State<LoanFailedPage> createState() => _LoanFailedPageState();
}

class _LoanFailedPageState extends State<LoanFailedPage> {
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        ...
                        // Status Card (similar to the right column card)
                        const Card(
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        ...
                        _buildDetailsRow(
                            "Interest", "10 %", "Repayment Amount", "CDF 500"),
                        ...
                        // Removed the download and share options and the line
                      ],
                    ),
                  ),
                ],
